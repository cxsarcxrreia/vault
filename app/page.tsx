    ...
    <main className="min-h-screen bg-background">
      <section className="mx-auto flex min-h-screen max-w-5xl flex-col justify-center px-6 py-16">
        <div className="max-w-3xl">
          <p className="text-sm font-medium text-muted-foreground">Creative Agency Client Portal</p>
          <h1 className="mt-4 text-4xl font-semibold tracking-normal md:text-6xl">
            A quiet operating layer for client projects.
          </h1>
          <p className="mt-5 max-w-2xl text-base leading-7 text-muted-foreground">
            Track macro phases, deliverables, approvals, documents, and responsibilities without replacing WhatsApp or Google Drive.
          </p>
